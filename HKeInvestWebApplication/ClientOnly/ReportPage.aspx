<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReportPage.aspx.cs" Inherits="HKeInvestWebApplication.ClientOnly.ReportPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <h3>Active Order</h3>
        <div>
            <asp:GridView ID="OrderStatus" runat="server" OnSorting="OrderStatus_Sorting" AutoGenerateColumns="False" AllowSorting="false">
                <Columns>
